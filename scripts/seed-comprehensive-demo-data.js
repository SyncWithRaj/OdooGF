...
async function seed() {
  ...
  const quotationsToCreate = [
    ...
    },
    {
      ...
      notes: 'Renewal package with custom pricing. Exceeds standard Gold tier ceiling by 2pt.',
      lines: [
        { productIdx: 1, qty: 4, unitPrice: 4899, unitCost: 3200, discount: 17, allowed: 15, isOver: true, overPoints: 2 },
        { productIdx: 6, qty: 12, unitPrice: 1250, unitCost: 450, discount: 16, allowed: 15, isOver: true, overPoints: 1 },
      ],
      currentStage: ApprovalStage.SALES_MANAGER,
    },
    {
    ...
    },
    {
      ...
      status: QuotationStatus.PENDING_APPROVAL,
      risk: RiskLevel.MEDIUM,
      notes: 'Hardware bundle request exceeding 10% ceiling. Routed for Manager sign-off.',
      lines: [
        { productIdx: 0, qty: 8, unitPrice: 1299, unitCost: 850, discount: 14, allowed: 10, isOver: true, overPoints: 4 },
        { productIdx: 3, qty: 8, unitPrice: 45, unitCost: 22, discount: 12, allowed: 10, isOver: true, overPoints: 2 },
      ],
      currentStage: ApprovalStage.SALES_MANAGER,
    },
    {
    ...
    },
    {
      ...
      status: QuotationStatus.PENDING_APPROVAL,
      risk: RiskLevel.HIGH,
      notes: 'Deep volume discount exceeding Silver ceiling by 8pt. Requires Finance Controller approval.',
      lines: [
        { productIdx: 1, qty: 3, unitPrice: 4899, unitCost: 3200, discount: 18, allowed: 10, isOver: true, overPoints: 8 },
        { productIdx: 7, qty: 4, unitPrice: 1500, unitCost: 600, discount: 15, allowed: 10, isOver: true, overPoints: 5 },
      ],
      currentStage: ApprovalStage.FINANCE,
    },
    {
      ...
      status: QuotationStatus.PENDING_APPROVAL,
      risk: RiskLevel.MEDIUM,
      notes: 'Hardware refresh for store rollout with 8% discount over Bronze 5% limit.',
      lines: [
        { productIdx: 0, qty: 5, unitPrice: 1299, unitCost: 850, discount: 8, allowed: 5, isOver: true, overPoints: 3 },
        { productIdx: 3, qty: 5, unitPrice: 45, unitCost: 22, discount: 7, allowed: 5, isOver: true, overPoints: 2 },
      ],
      currentStage: ApprovalStage.SALES_MANAGER,
    },
  ];
